...
<head>
	...
	<title>L@PSHOPEEZ Home Page</title>
	...
	<link href="assets/css/w3-theme-blue.css" rel="alternate stylesheet" title="ATBlue  color">
						...
						<div id="hero" class="homepage-slider3">
							<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
								<div class="full-width-slider">
									<div class="item" style="background-image: url(assets/images/sliders/laptopbanner1.jpg);">
										<!-- /.container-fluid -->
									</div><!-- /.item -->
								</div><!-- /.full-width-slider -->

								<div class="full-width-slider">
									<div class="item full-width-slider" style="background-image: url(assets/images/sliders/laptopbanner2.png);">
									</div><!-- /.item -->
								</div><!-- /.full-width-slider -->
									...
									<div class="col-md-6 col-sm-4 col-lg-4">
										<div class="info-box">
											<div class="row">
												...
												<div class="col-xs-10">
													<h4 class="info-box-heading green">Best Value For Money !!!!!!!</h4>
												</div>
											</div>
											<h6 class="text">Deals Seen Never Before </h6>
										</div>
									</div><!-- .col -->
									...
									<div class="hidden-md col-sm-4 col-lg-4">
										<div class="info-box">
											<div class="row">
												...
												<div class="col-xs-10">
													<h4 class="info-box-heading blue">Best after sells support</h4>
												</div>
											</div>
											<h6 class="text">Full coustomer satisfaction</h6>
										</div>
									</div><!-- .col -->
									...
									<div class="col-md-6 col-sm-4 col-lg-4">
										<div class="info-box">
											<div class="row">
												...
												<div class="col-xs-10">
													<h4 class="info-box-heading red">Flash Sale for limited time</h4>
												</div>
											</div>
											<h6 class="text">Grab youre offer now!!! </h6>
										</div>
									</div><!-- .col -->
								</div><!-- /.row -->
					...
					<div class="row">
						<div class="col-md-6">
							<section class="section">
								<h3 class="section-title">Mac <i class="fa fa-apple" style="font-size:24px"></i> </h3>
						...
						<div class="col-md-6">
							<section class="section">
								<h3 class="section-title">Laptops For Students <!--<i class="fa fa-windows" style="font-size:24px"></i>--></h3>
								<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
									<?php
